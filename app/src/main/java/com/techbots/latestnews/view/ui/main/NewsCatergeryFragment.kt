...
class NewsCatergeryFragment : Fragment(), NewsArticleViewModel.CallBacks{
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(sectionNumber: Int, string: String): NewsCatergeryFragment {
            return NewsCatergeryFragment().apply {
